class User:
    ...
    def increase_rating(self):
        new_increased_rating = self.rating + 0.5
        if new_increased_rating >= 10:
            self.rating = 10
        else:
            self.rating = new_increased_rating

    def decrease_rating(self):
        new_decreased_rating = self.rating - 2
        if new_decreased_rating < 0:
            self.is_blocked = True
            self.rating = 0
        else:
            self.rating = new_decreased_rating
